...
#(
    ...
    parameter int           CLK_FREQUENCE = 100_000_000,
    parameter int           BAUD_RATE   = 115_200,
    parameter int           MEM_WIDTH   = 65_536,
    parameter string        BIN_FILE    = "../../app/hello.bin"    
)
(
    input  logic       clk,
    input  logic       reset_n,
...
//////////////////////////////////////////////////////////////////////////////
    ...
    if(Environment == FPGA) begin : FPGA_mode
        BRAM RAM (
            ...
            .doutb  (data_ram)                 // output wire [31 : 0] doutb
        );
    end
    else if(Environment ==  ASIC) begin : ASIC_mode
        RAM_mem #(
            .MEM_WIDTH(MEM_WIDTH),
            .BIN_FILE (BIN_FILE)
        ) RAM_MEM (
            ...
            .enA_i      (1'b1),
            .weA_i      (4'h0),
            .addrA_i    (cpu_instruction_address[($clog2(MEM_WIDTH) - 1):0]),
            .dataA_i    (32'h00000000),
            .dataA_o    (cpu_instruction),
            .enB_i      (enable_ram),
            .weB_i      (cpu_write_enable),
            .addrB_i    (cpu_data_address[($clog2(MEM_WIDTH) - 1):0]),
            .dataB_i    (cpu_data_out),
            .dataB_o    (data_ram)
        );
    end
